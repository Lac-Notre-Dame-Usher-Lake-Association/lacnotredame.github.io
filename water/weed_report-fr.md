...
Même si nous avons apprécié l'effort communautaire, il est clair que gérer nous-mêmes les mauvaises herbes sera une entreprise colossale. Pour continuer avec les bénévoles et la découpe manuelle, il faudrait investir dans des outils et des méthodes :

1. Booms améliorés : un boom à base de nouilles de 15 $ s'est révélé prometteur, mais nous avons besoin d'une configuration beaucoup plus grande.
2. Appareil à deux canoës : Robert a partagé des idées du camp, en utilisant une configuration entre deux canoës.
3. Bateau à façade plate (comme un bateau Jon) avec moteur électrique pour un retrait plus efficace.
