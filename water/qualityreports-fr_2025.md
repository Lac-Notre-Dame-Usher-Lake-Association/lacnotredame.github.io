...
* Des échantillons d'eau ont été prélevés au fil des ans aux endroits indiqués sur la [carte](https://lacnotredame.org/map/Lac_Notre_Dame_interactive_map-fr.html). Vos cotisations et dons à l'association financent ces analyses.

#### Lac Usher - Résumé du 12 août 2025

* Le lac Usher présente de meilleurs résultats que les années précédentes. Les niveaux de bactéries, avec un taux d'E. coli plus élevé (60 UFC) [à l'emplacement 10](https://lacnotredame.org/map/Lac_Notre_Dame_interactive_map-fr.html), sont bien inférieurs à la limite de 200 UFC pour la baignade en toute sécurité.
...
* [Carte des lieux où l’eau a été testée depuis le début du programme](https://lacnotredame.org/map/Lac_Notre_Dame_interactive_map-fr.html).
